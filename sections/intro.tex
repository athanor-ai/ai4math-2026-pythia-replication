...
\citep{moura2021lean, mathlib2020community, mathlib2025}. Forward
search lives in \texttt{aesop} and rewriting in \texttt{simp}.
Arithmetic is split across \texttt{linarith}, \texttt{polyrith},
and \texttt{nlinarith}. Sign goals route through \texttt{positivity}
and the $\sigma$-algebra fragment through \texttt{measurability}.
Monotone composition uses \texttt{bound} and generalised congruence
uses \texttt{gcongr}.
